...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_web_app"></a> [container\_web\_app](#module\_container\_web\_app) | ./modules/container_web_app | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_app_service_container"></a> [app\_service\_container](#output\_app\_service\_container) | App Service Container (Container WebApp) output object if Container is choosen. Please refer to `./modules/container-web-app/README.md` |
